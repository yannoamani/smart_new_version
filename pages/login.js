...
<Text style={style.labelText}>Mot de passe</Text>
<View style={{ height: "1%" }}></View>
...
{
  checked ? <Ionicons name="checkmark"  color="#1A9E47" /> : null
}
</View>
</Pressable > 
<Text style={style.checkText}>Se souvenir de moi</Text>
...
<Pressable
  ...
  onPress={validation}
>
<Text style={style.textbutton}>Se connecter</Text>
...
<Text style={style.connectwith}>ou  connectez-vous avec </Text>
...
<View style={style.connectCard}>
  <View style={style.cards}>
    <Ionicons name="logo-facebook" size={24} color="#4267B2"></Ionicons>
    <Text style={style.cardText}>Facebook</Text>

  </View>
  <View style={style.cards}>
    <Ionicons name="logo-google" size={24} color={"#4285F4"}></Ionicons>
    <Text style={style.cardText}>Google</Text>
...
<View style={{flex:1, backgroundColor:'#F1F2F4'}} >
    ...
    color="white" style={style.back}></Ionicons>

    </View>
    <ScrollView >
  <View style={style.conatainerReset}>
 
    <Text style={style.titlereset}>
     Mot de passe oublié
    </Text>
  
   
    <View style={{ height: 20 }}></View>
    <Text style={style.subTitleReset}>Saisissez l'adresse électronique associée à votre 
compte et nous vous enverrons par courrier 
électronique des instructions pour réinitialiser 
votre mot de passe.</Text>
    ...
    <Pressable onPress={validationPassword} style={style.button}>
